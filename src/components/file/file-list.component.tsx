  ...
  render() {
    ...
    const columns: any = [
      ...
      },
      {
        ...
        render: (text, row, index) => (
          <span>
            <i className="iconfont icondownload icon-primary pointer" onClick={this.downloadAction.bind(this, row)}></i>
          </span>
        ),
      },
      {
        ...
        render: (text, row, index) => (
          <span>
            <i className="iconfont icondelete icon-primary pointer" onClick={this.removeAction.bind(this, row)}></i>
          </span>
        ),
      },
    ]

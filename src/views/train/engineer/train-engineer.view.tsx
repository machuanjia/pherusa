      ...
      <ContentLayoutComponent>
        ...
        <Fragment key="main">
          <SimpleLayoutComponent>
            <Fragment key="desc">
              UiBot 工程师认证分为初级、中级和高级。初级和中级认证采用在线答题、自动判卷的方式，面向 所有人开放。
              高级认证采用实战开发、文档撰写、使用 UiBot Commander 和 UiBot Worker 进行任务编排的形
              式，并且由人工判卷。通常需要五个工作日完成答题，还需要五个工作日判定结果。
              高级认证仅向来也科技合作伙伴开放，您需要提前申请邀请码，才能有资格参加高级认证。
            </Fragment>
            <Fragment key="action">
              <a href="https://academy.uibot.com.cn/certificate" target="_blank" rel="noopener noreferrer">
